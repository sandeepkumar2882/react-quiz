...
const QuizInstructions = () => (
    <Fragment>
        ...
        <div className="instructions container">
            ...
            <h2 className='h2-instructions'>How to Play the Game</h2>
            ...
            <div>
                <span className="left"><Link to="/">Not Interested, Go Back</Link></span>
                <span className="right"><Link to="/play/quiz">Okay, Let's Play Quiz!</Link></span>
            </div>
        </div>
    </Fragment>
);
